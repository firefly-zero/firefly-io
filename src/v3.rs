...
pub fn run_v3(peripherals: Peripherals) -> Result<()> {
    ...
    // Enable power on SD card.
    let pwr = peripherals.GPIO12;
    ...
    let buttons = Buttons {
        s: Input::new(peripherals.GPIO5, up),
        e: Input::new(peripherals.GPIO4, up),
        w: Input::new(peripherals.GPIO7, up),
        n: Input::new(peripherals.GPIO6, up),
        menu: Input::new(peripherals.GPIO15, up),
    };
